...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/FullStory/FullStory.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FullStorySegmentMiddleware/FullStorySegmentMiddleware.framework"
